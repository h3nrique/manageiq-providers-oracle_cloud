module ManageIQ::Providers::OracleCloud::ManagerMixin
  ...
  def connect(options = {})
    ...
    self.class.raw_connect(username, password, domain, region, compute_api, storage_api)
  end
  ...
  module ClassMethods
    def raw_connect(username, password, domain, region, compute_api = nil, storage_api = nil)
